...
struct FoozleCell_Previews: PreviewProvider {
    static var previews: some View {
        FoozleRowCell(game: GameGeneralResponse.GameResponse(id: 1, name: "test", backgroundImage: "test", released: "today", platforms: [], genres: [], stores: [], esrbRating: ESRBRating(id: 1, name: "mature")))
    }
}
